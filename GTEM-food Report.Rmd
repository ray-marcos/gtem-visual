...
# Crops
# rice = gtem.Pn.chart(comID.ANO = "Rice", comID.hist = "Rice", comID.GTEM = "5 Rice", sm.factor = 0.01)
# wheat = gtem.Pn.chart(comID.ANO = "Whea", comID.hist = "Wheat", comID.GTEM = "6 Wheat" , sm.factor = 0.01)
# sugar = gtem.Pn.chart(comID.ANO = "SugC" , comID.hist = "Sugar cane" , comID.GTEM = "10 Cane_beet"  , sm.factor = 0.01)
